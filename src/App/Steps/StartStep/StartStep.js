...
class StartStep extends React.Component {
  ...
  render() {
    if (this.props.currentStep !== AppConfig.steps.Start) return null;

    return (
      <div>
        <div className="App-title">Welcome to Luna's Ice Cream Shoppe</div>
        <div className="App-subtitle">
          We have been crafting the most hip, award winning, delicious ice cream
          the world has ever seen for over 30 years.
        </div>
