...
class Flavors extends React.Component {
  render() {
    const flavorList = this.props.Flavors.map((Flavor, FlavorIndex) => {
      return (
        <div key={FlavorIndex} className="Order-Item-container">
...
class Toppings extends React.Component {
  render() {
    const toppingList = this.props.Toppings.map((Topping, ToppingIndex) => {
      return (
        <div key={ToppingIndex} className="Order-Item-container">
      ...
      return (
        <div key={Index} className="Order-Item">
          ...
          {Item.Toppings.length > 0 ? (
            <div className="Item-category">Toppings</div>
          ) : null}
...
class ConfirmStep extends React.Component {
  ...
  render() {
    if (this.props.currentStep !== AppConfig.steps.Confirm) return null;
    ...
    return (
      <div className="App-header-padding">
        ...
        <div
          ...
          onClick={() => this.stepHandler(AppConfig.steps.Payment)}
        >
