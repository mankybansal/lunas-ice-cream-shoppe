...
class FlavorsList extends React.Component {
  ...
  removeFlavor(item, e) {
    ...
    if (Order.CurrentItem.Flavors.includes(item))
      Order.CurrentItem.Flavors.splice(
        Order.CurrentItem.Flavors.indexOf(item),
        1
      );
  ...
  render() {
    const listItems = this.props.Flavors.map((Flavor) => {
      ...
      if (
        this.props.Order.CurrentItem.Flavors.length > 0 &&
        this.props.Order.CurrentItem.Flavors.includes(Flavor)
      ) {
            ...
            <div className="MultiScoop-container">
              ...
              <div
                className={
                  ...
                  this.props.Order.CurrentItem.Flavors.length < flavorCountMax
              ...
              <div
                ...
                onClick={(e) => this.removeFlavor(Flavor, e)}
              >
                Remove
              </div>
            </div>
...
class FlavorsStep extends React.Component {
  ...
  stepHandler(gotoStep) {
    if (gotoStep < this.props.currentStep) this.props.stepHandler(gotoStep);
      ...
      } else alert("Select at least one scoop");
    }
  }

  render() {
    if (this.props.currentStep !== AppConfig.steps.Flavors) return null;

    let prompt =
      "Select Up To " +
      (this.props.Order.CurrentItem.Serving
        ? this.props.Order.CurrentItem.Serving.scoops
        : 0) +
      " Flavors";
    ...
    return (
      <div className="App-header-padding">
        ...
        <div
          ...
          onClick={() => this.stepHandler(AppConfig.steps.Servings)}
        >
        ...
        <div
          ...
          onClick={() => this.stepHandler(AppConfig.steps.Toppings)}
        >
